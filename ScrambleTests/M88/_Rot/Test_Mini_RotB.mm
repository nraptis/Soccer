...
@interface Test_Mini_RotB : XCTestCase

@end

@implementation Test_Mini_RotB


- (void)testMini_RotB_2x2_A {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniA();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_A();
...
- (void)testMini_RotB_2x2_B {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniB();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_B();
...
- (void)testMini_RotB_2x2_C {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniC();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_C();
...
- (void)testMini_RotB_2x2_D {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniD();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_D();
...
- (void)testMini_RotB_2x2_E {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniE();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_E();
...
- (void)testMini_RotB_2x2_F {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniF();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_F();
...
- (void)testMini_RotB_2x2_G {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniG();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_G();
...
- (void)testMini_RotB_2x2_H {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniH();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_H();
...
- (void)testMini_RotB_2x2_I {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniI();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_I();
...
- (void)testMini_RotB_2x2_J {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniJ();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_J();
...
- (void)testMini_RotB_2x2_K {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniK();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_K();
...
- (void)testMini_RotB_2x2_L {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniL();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_L();
...
- (void)testMini_RotB_2x2_M {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniM();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_M();
...
- (void)testMini_RotB_2x2_N {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniN();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_N();
...
- (void)testMini_RotB_2x2_O {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniO();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_O();
...
- (void)testMini_RotB_2x2_P {
    M88 aBefore = VerifyMini::SpawnTestMatrixMiniP();
    M88 aAfter = aBefore;

    aAfter.Mini_RotB_2x2_P();
