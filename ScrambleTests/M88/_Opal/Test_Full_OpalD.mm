...
@interface Test_Full_OpalD : XCTestCase

@end

@implementation Test_Full_OpalD

- (void)testFull_OpalD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_OpalD_4x4();
...
- (void)testFull_OpalD_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_OpalD_EachQuad_4x4();
...
- (void)testFull_OpalD_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_OpalD_8x8();
