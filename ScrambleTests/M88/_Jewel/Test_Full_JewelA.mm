...
@interface Test_Full_JewelA : XCTestCase

@end

@implementation Test_Full_JewelA

- (void)testFull_JewelA_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_JewelA_4x4();
...
- (void)testFull_JewelA_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_JewelA_EachQuad_4x4();
...
- (void)testFull_JewelA_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_JewelA_8x8();
