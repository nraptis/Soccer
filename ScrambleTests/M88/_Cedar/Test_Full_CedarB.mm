...
@interface Test_Full_CedarB : XCTestCase

@end

@implementation Test_Full_CedarB

- (void)testFull_CedarB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_CedarB_4x4();
...
- (void)testFull_CedarB_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_CedarB_EachQuad_4x4();
...
- (void)testFull_CedarB_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_CedarB_8x8();
