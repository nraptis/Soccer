...
@interface Test_Full_JewelB : XCTestCase

@end

@implementation Test_Full_JewelB

- (void)testFull_JewelB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_JewelB_4x4();
...
- (void)testFull_JewelB_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_JewelB_EachQuad_4x4();
...
- (void)testFull_JewelB_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_JewelB_8x8();
