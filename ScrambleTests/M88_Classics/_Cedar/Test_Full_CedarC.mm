...
@interface Test_Full_CedarC : XCTestCase

@end

@implementation Test_Full_CedarC

- (void)testFull_CedarC_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_CedarC_4x4();
...
- (void)testFull_CedarC_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_CedarC_EachQuad_4x4();
...
- (void)testFull_CedarC_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_CedarC_8x8();
