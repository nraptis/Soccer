...
@interface Test_Full_CedarA : XCTestCase

@end

@implementation Test_Full_CedarA

- (void)testFull_CedarA_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_CedarA_4x4();
...
- (void)testFull_CedarA_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_CedarA_EachQuad_4x4();
...
- (void)testFull_CedarA_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_CedarA_8x8();
