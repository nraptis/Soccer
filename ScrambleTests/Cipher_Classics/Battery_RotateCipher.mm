...
- (void)test_fixed_112_C_RotateCipher {
    ...
    std::size_t aRotationAmount = 106;
...
- (void)test_fixed_112_E_RotateCipher {
    ...
    std::size_t aRotationAmount = 100;
