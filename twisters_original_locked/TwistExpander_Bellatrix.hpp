...
#include "TwistExpander_Bellatrix_Arx.hpp"

class TwistExpander_Bellatrix : public TwistExpander {
public:
    TwistExpander_Bellatrix();
    ~TwistExpander_Bellatrix() override = default;
