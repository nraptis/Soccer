//
//  SoccerFolding_1360.hpp
//  Generated by SoccerFoldingTool
//
// Trials per roll: 1360. Run seed: 15111071204579142915. Overall score: 84.35/100.
// Compile this header with only its matching generated .cpp file.
//

#ifndef SoccerFolding_1360_hpp
#define SoccerFolding_1360_hpp
...
public:
    ...
    static void BrickFold_4(const std::uint8_t *pSourceA,
                            const std::uint8_t *pSourceB,
                            const std::uint8_t *pSourceC,
                            const std::uint8_t *pSourceD,
                            std::uint8_t *pDestinationA,
