#ifndef JELLY_SPLINT_MASK_BLOCK_CIPHER_32_HPP_
#define JELLY_SPLINT_MASK_BLOCK_CIPHER_32_HPP_
...
class SplintMaskBlockCipher32 final : public Cipher {
 public:
  explicit SplintMaskBlockCipher32(std::uint8_t pMask)
      : Cipher(CipherType::kSplintMaskBlockCipher32),
        mMask(pMask) {}
...
#endif  // JELLY_SPLINT_MASK_BLOCK_CIPHER_32_HPP_
