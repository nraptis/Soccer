...
public:
    ...
    static void                 KeyDiffuseWithDomainWords(std::uint8_t *pInputLaneA,
                                                          std::uint8_t *pInputLaneB,
                                                          std::uint8_t *pInputLaneC,
                                                          std::uint8_t *pInputLaneD,
                                                          std::uint8_t *pOutputLaneA,
    ...
    static void                 KeyDiffuseWithDomainWordsA(std::uint8_t *pInputLaneA,
                                                           std::uint8_t *pInputLaneB,
                                                           std::uint8_t *pInputLaneC,
                                                           std::uint8_t *pInputLaneD,
                                                           std::uint8_t *pOutputLaneA,
    ...
    static void                 KeyDiffuseWithDomainWordsB(std::uint8_t *pInputLaneA,
                                                           std::uint8_t *pInputLaneB,
                                                           std::uint8_t *pInputLaneC,
                                                           std::uint8_t *pInputLaneD,
                                                           std::uint8_t *pOutputLaneA,
