...
#define CASTOR_KEY_A_A_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 12U))
#define CASTOR_KEY_A_A_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 7U))
#define CASTOR_KEY_A_A_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 10U))
#define CASTOR_KEY_A_A_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 1U))
...
#define CASTOR_KEY_A_A_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 9U))
#define CASTOR_KEY_A_A_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 7U))
...
#define CASTOR_KEY_A_A_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_A_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_A_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 4U))
#define CASTOR_KEY_A_A_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 5U))
...
#define CASTOR_KEY_A_A_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_A_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 15U))
#define CASTOR_KEY_A_A_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 7U))
#define CASTOR_KEY_A_A_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 10U))
#define CASTOR_KEY_A_A_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 5U))
#define CASTOR_KEY_A_A_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 2U))
#define CASTOR_KEY_A_A_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 1U))
#define CASTOR_KEY_A_A_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 6U))
#define CASTOR_KEY_A_A_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_A_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 6U))
#define CASTOR_KEY_A_A_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 14U))
#define CASTOR_KEY_A_A_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 13U))
...
#define CASTOR_KEY_A_A_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 15U))
#define CASTOR_KEY_A_A_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 10U))
#define CASTOR_KEY_A_A_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 4U))
#define CASTOR_KEY_A_A_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 14U))
...
#define CASTOR_KEY_A_A_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 5U))
#define CASTOR_KEY_A_A_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 9U))
#define CASTOR_KEY_A_A_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 4U))
#define CASTOR_KEY_A_A_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 0U))
#define CASTOR_KEY_A_A_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 6U))
#define CASTOR_KEY_A_A_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_A_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 5U))
#define CASTOR_KEY_A_A_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 2U))
#define CASTOR_KEY_A_A_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 4U))
#define CASTOR_KEY_A_A_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_A_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 9U))
#define CASTOR_KEY_A_A_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 3U))
#define CASTOR_KEY_A_A_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 11U))
#define CASTOR_KEY_A_A_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 10U))
#define CASTOR_KEY_A_A_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 7U))
#define CASTOR_KEY_A_A_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 8U))
#define CASTOR_KEY_A_A_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 9U))
#define CASTOR_KEY_A_A_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 0U))
#define CASTOR_KEY_A_A_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 2U))
#define CASTOR_KEY_A_A_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 14U))
#define CASTOR_KEY_A_A_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 11U))
#define CASTOR_KEY_A_A_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_A_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 4U))
#define CASTOR_KEY_A_A_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 12U))
#define CASTOR_KEY_A_A_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 10U))
#define CASTOR_KEY_A_A_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 15U))
#define CASTOR_KEY_A_A_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 2U))
#define CASTOR_KEY_A_A_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 6U))
#define CASTOR_KEY_A_A_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 6U))
#define CASTOR_KEY_A_A_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 1U))
#define CASTOR_KEY_A_A_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 12U))
#define CASTOR_KEY_A_A_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 11U))
...
#define CASTOR_KEY_A_B_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 11U))
#define CASTOR_KEY_A_B_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 6U))
#define CASTOR_KEY_A_B_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 3U))
#define CASTOR_KEY_A_B_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 0U))
...
#define CASTOR_KEY_A_B_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 1U))
#define CASTOR_KEY_A_B_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_B_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 11U))
#define CASTOR_KEY_A_B_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 9U))
...
#define CASTOR_KEY_A_B_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_B_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 1U))
#define CASTOR_KEY_A_B_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 11U))
#define CASTOR_KEY_A_B_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 13U))
...
#define CASTOR_KEY_A_B_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 13U))
#define CASTOR_KEY_A_B_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 9U))
#define CASTOR_KEY_A_B_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 12U))
#define CASTOR_KEY_A_B_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 3U))
#define CASTOR_KEY_A_B_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 9U))
#define CASTOR_KEY_A_B_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 13U))
#define CASTOR_KEY_A_B_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 15U))
#define CASTOR_KEY_A_B_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 4U))
#define CASTOR_KEY_A_B_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 15U))
#define CASTOR_KEY_A_B_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 2U))
#define CASTOR_KEY_A_B_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 1U))
...
#define CASTOR_KEY_A_B_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 4U))
#define CASTOR_KEY_A_B_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_B_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 9U))
#define CASTOR_KEY_A_B_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 15U))
...
#define CASTOR_KEY_A_B_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 3U))
#define CASTOR_KEY_A_B_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 4U))
#define CASTOR_KEY_A_B_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 6U))
#define CASTOR_KEY_A_B_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 11U))
#define CASTOR_KEY_A_B_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_B_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 9U))
#define CASTOR_KEY_A_B_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 4U))
#define CASTOR_KEY_A_B_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 10U))
#define CASTOR_KEY_A_B_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 11U))
#define CASTOR_KEY_A_B_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 0U))
#define CASTOR_KEY_A_B_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 6U))
#define CASTOR_KEY_A_B_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 1U))
#define CASTOR_KEY_A_B_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 8U))
#define CASTOR_KEY_A_B_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_B_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 6U))
#define CASTOR_KEY_A_B_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 12U))
#define CASTOR_KEY_A_B_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_B_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 1U))
#define CASTOR_KEY_A_B_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 4U))
#define CASTOR_KEY_A_B_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 10U))
#define CASTOR_KEY_A_B_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 14U))
#define CASTOR_KEY_A_B_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 4U))
#define CASTOR_KEY_A_B_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_B_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 15U))
#define CASTOR_KEY_A_B_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 13U))
#define CASTOR_KEY_A_B_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_B_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 12U))
#define CASTOR_KEY_A_B_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 14U))
#define CASTOR_KEY_A_B_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 10U))
#define CASTOR_KEY_A_B_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 11U))
#define CASTOR_KEY_A_B_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 15U))
...
#define CASTOR_KEY_A_C_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 8U))
#define CASTOR_KEY_A_C_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 1U))
#define CASTOR_KEY_A_C_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 15U))
#define CASTOR_KEY_A_C_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 14U))
...
#define CASTOR_KEY_A_C_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 9U))
#define CASTOR_KEY_A_C_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 10U))
#define CASTOR_KEY_A_C_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_C_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 12U))
...
#define CASTOR_KEY_A_C_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 1U))
#define CASTOR_KEY_A_C_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 5U))
#define CASTOR_KEY_A_C_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 2U))
#define CASTOR_KEY_A_C_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 9U))
...
#define CASTOR_KEY_A_C_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 4U))
#define CASTOR_KEY_A_C_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 1U))
#define CASTOR_KEY_A_C_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 13U))
#define CASTOR_KEY_A_C_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 6U))
#define CASTOR_KEY_A_C_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_C_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 0U))
#define CASTOR_KEY_A_C_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 14U))
#define CASTOR_KEY_A_C_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 5U))
#define CASTOR_KEY_A_C_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 4U))
#define CASTOR_KEY_A_C_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 9U))
#define CASTOR_KEY_A_C_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 0U))
...
#define CASTOR_KEY_A_C_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 11U))
#define CASTOR_KEY_A_C_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 15U))
#define CASTOR_KEY_A_C_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 3U))
#define CASTOR_KEY_A_C_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 7U))
...
#define CASTOR_KEY_A_C_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 8U))
#define CASTOR_KEY_A_C_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 1U))
#define CASTOR_KEY_A_C_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 2U))
#define CASTOR_KEY_A_C_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 9U))
#define CASTOR_KEY_A_C_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 4U))
#define CASTOR_KEY_A_C_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 14U))
#define CASTOR_KEY_A_C_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 9U))
#define CASTOR_KEY_A_C_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 7U))
#define CASTOR_KEY_A_C_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 6U))
#define CASTOR_KEY_A_C_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 5U))
#define CASTOR_KEY_A_C_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_C_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 14U))
#define CASTOR_KEY_A_C_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 0U))
#define CASTOR_KEY_A_C_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 4U))
#define CASTOR_KEY_A_C_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 2U))
#define CASTOR_KEY_A_C_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 14U))
#define CASTOR_KEY_A_C_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 8U))
#define CASTOR_KEY_A_C_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 2U))
#define CASTOR_KEY_A_C_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_C_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 12U))
#define CASTOR_KEY_A_C_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 10U))
#define CASTOR_KEY_A_C_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 15U))
#define CASTOR_KEY_A_C_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 8U))
#define CASTOR_KEY_A_C_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 2U))
#define CASTOR_KEY_A_C_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_C_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 0U))
#define CASTOR_KEY_A_C_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 11U))
#define CASTOR_KEY_A_C_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 4U))
#define CASTOR_KEY_A_C_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 9U))
#define CASTOR_KEY_A_C_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 10U))
#define CASTOR_KEY_A_C_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_C_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 5U))
...
#define CASTOR_KEY_A_D_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 13U))
#define CASTOR_KEY_A_D_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 8U))
#define CASTOR_KEY_A_D_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 0U))
#define CASTOR_KEY_A_D_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 3U))
...
#define CASTOR_KEY_A_D_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_D_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 0U))
#define CASTOR_KEY_A_D_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 10U))
#define CASTOR_KEY_A_D_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 14U))
...
#define CASTOR_KEY_A_D_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 12U))
#define CASTOR_KEY_A_D_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 11U))
#define CASTOR_KEY_A_D_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 7U))
#define CASTOR_KEY_A_D_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 0U))
...
#define CASTOR_KEY_A_D_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 6U))
#define CASTOR_KEY_A_D_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 7U))
#define CASTOR_KEY_A_D_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 4U))
#define CASTOR_KEY_A_D_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 5U))
#define CASTOR_KEY_A_D_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 14U))
#define CASTOR_KEY_A_D_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 7U))
#define CASTOR_KEY_A_D_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_D_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 8U))
#define CASTOR_KEY_A_D_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_D_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 9U))
#define CASTOR_KEY_A_D_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 12U))
...
#define CASTOR_KEY_A_D_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 0U))
#define CASTOR_KEY_A_D_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 13U))
#define CASTOR_KEY_A_D_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 2U))
...
#define CASTOR_KEY_A_D_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_D_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 0U))
#define CASTOR_KEY_A_D_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 11U))
#define CASTOR_KEY_A_D_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 3U))
#define CASTOR_KEY_A_D_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 3U))
#define CASTOR_KEY_A_D_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 15U))
#define CASTOR_KEY_A_D_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_D_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 5U))
#define CASTOR_KEY_A_D_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 9U))
#define CASTOR_KEY_A_D_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 8U))
#define CASTOR_KEY_A_D_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 2U))
#define CASTOR_KEY_A_D_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 7U))
#define CASTOR_KEY_A_D_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 13U))
#define CASTOR_KEY_A_D_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 14U))
#define CASTOR_KEY_A_D_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 11U))
#define CASTOR_KEY_A_D_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 2U))
#define CASTOR_KEY_A_D_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 15U))
#define CASTOR_KEY_A_D_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 4U))
#define CASTOR_KEY_A_D_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 3U))
#define CASTOR_KEY_A_D_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 11U))
#define CASTOR_KEY_A_D_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 13U))
#define CASTOR_KEY_A_D_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 6U))
#define CASTOR_KEY_A_D_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 2U))
#define CASTOR_KEY_A_D_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 9U))
#define CASTOR_KEY_A_D_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 1U))
#define CASTOR_KEY_A_D_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 14U))
#define CASTOR_KEY_A_D_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 5U))
#define CASTOR_KEY_A_D_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 13U))
#define CASTOR_KEY_A_D_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 4U))
#define CASTOR_KEY_A_D_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 6U))
#define CASTOR_KEY_A_D_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 3U))
#define CASTOR_KEY_A_D_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 10U))
...
#define CASTOR_KEY_A_E_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_E_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 5U))
#define CASTOR_KEY_A_E_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 1U))
#define CASTOR_KEY_A_E_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 10U))
...
#define CASTOR_KEY_A_E_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 7U))
#define CASTOR_KEY_A_E_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 1U))
#define CASTOR_KEY_A_E_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 10U))
...
#define CASTOR_KEY_A_E_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 14U))
#define CASTOR_KEY_A_E_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_E_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 8U))
#define CASTOR_KEY_A_E_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 7U))
...
#define CASTOR_KEY_A_E_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 1U))
#define CASTOR_KEY_A_E_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 2U))
#define CASTOR_KEY_A_E_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 6U))
#define CASTOR_KEY_A_E_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 12U))
#define CASTOR_KEY_A_E_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 8U))
#define CASTOR_KEY_A_E_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 5U))
#define CASTOR_KEY_A_E_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 12U))
#define CASTOR_KEY_A_E_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 15U))
#define CASTOR_KEY_A_E_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 14U))
#define CASTOR_KEY_A_E_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 11U))
#define CASTOR_KEY_A_E_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_E_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 6U))
...
#define CASTOR_KEY_A_E_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 8U))
#define CASTOR_KEY_A_E_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 9U))
#define CASTOR_KEY_A_E_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 5U))
#define CASTOR_KEY_A_E_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 3U))
...
#define CASTOR_KEY_A_E_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 5U))
#define CASTOR_KEY_A_E_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 10U))
#define CASTOR_KEY_A_E_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 12U))
#define CASTOR_KEY_A_E_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 11U))
#define CASTOR_KEY_A_E_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 1U))
#define CASTOR_KEY_A_E_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 9U))
#define CASTOR_KEY_A_E_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 10U))
#define CASTOR_KEY_A_E_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 2U))
#define CASTOR_KEY_A_E_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 11U))
#define CASTOR_KEY_A_E_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 5U))
#define CASTOR_KEY_A_E_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 4U))
#define CASTOR_KEY_A_E_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 2U))
#define CASTOR_KEY_A_E_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 15U))
#define CASTOR_KEY_A_E_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 11U))
#define CASTOR_KEY_A_E_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 12U))
#define CASTOR_KEY_A_E_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 5U))
#define CASTOR_KEY_A_E_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 1U))
#define CASTOR_KEY_A_E_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 13U))
#define CASTOR_KEY_A_E_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 12U))
#define CASTOR_KEY_A_E_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 13U))
#define CASTOR_KEY_A_E_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 0U))
#define CASTOR_KEY_A_E_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 8U))
#define CASTOR_KEY_A_E_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 8U))
#define CASTOR_KEY_A_E_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 13U))
#define CASTOR_KEY_A_E_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 3U))
#define CASTOR_KEY_A_E_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 1U))
#define CASTOR_KEY_A_E_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 14U))
#define CASTOR_KEY_A_E_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 8U))
#define CASTOR_KEY_A_E_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 10U))
#define CASTOR_KEY_A_E_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 4U))
...
#define CASTOR_KEY_A_F_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 15U))
#define CASTOR_KEY_A_F_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_F_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 6U))
#define CASTOR_KEY_A_F_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 8U))
...
#define CASTOR_KEY_A_F_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 13U))
#define CASTOR_KEY_A_F_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 9U))
#define CASTOR_KEY_A_F_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 3U))
#define CASTOR_KEY_A_F_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 1U))
...
#define CASTOR_KEY_A_F_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 4U))
#define CASTOR_KEY_A_F_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 7U))
#define CASTOR_KEY_A_F_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 6U))
...
#define CASTOR_KEY_A_F_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_F_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 13U))
#define CASTOR_KEY_A_F_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 8U))
#define CASTOR_KEY_A_F_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 11U))
#define CASTOR_KEY_A_F_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_F_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 15U))
#define CASTOR_KEY_A_F_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 10U))
#define CASTOR_KEY_A_F_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 5U))
#define CASTOR_KEY_A_F_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 8U))
#define CASTOR_KEY_A_F_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 13U))
#define CASTOR_KEY_A_F_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 7U))
#define CASTOR_KEY_A_F_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 14U))
...
#define CASTOR_KEY_A_F_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_F_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 14U))
#define CASTOR_KEY_A_F_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 11U))
#define CASTOR_KEY_A_F_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 1U))
...
#define CASTOR_KEY_A_F_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 15U))
#define CASTOR_KEY_A_F_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 13U))
#define CASTOR_KEY_A_F_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 9U))
#define CASTOR_KEY_A_F_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 8U))
#define CASTOR_KEY_A_F_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 1U))
#define CASTOR_KEY_A_F_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 10U))
#define CASTOR_KEY_A_F_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 11U))
#define CASTOR_KEY_A_F_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 14U))
#define CASTOR_KEY_A_F_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 12U))
#define CASTOR_KEY_A_F_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 14U))
#define CASTOR_KEY_A_F_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 8U))
#define CASTOR_KEY_A_F_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 11U))
#define CASTOR_KEY_A_F_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_F_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_F_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 1U))
#define CASTOR_KEY_A_F_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 6U))
#define CASTOR_KEY_A_F_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 6U))
#define CASTOR_KEY_A_F_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_F_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 14U))
#define CASTOR_KEY_A_F_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 9U))
#define CASTOR_KEY_A_F_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 15U))
#define CASTOR_KEY_A_F_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 0U))
#define CASTOR_KEY_A_F_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 9U))
#define CASTOR_KEY_A_F_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 1U))
#define CASTOR_KEY_A_F_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 3U))
#define CASTOR_KEY_A_F_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_F_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 6U))
#define CASTOR_KEY_A_F_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 5U))
#define CASTOR_KEY_A_F_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 3U))
#define CASTOR_KEY_A_F_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_F_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 2U))
#define CASTOR_KEY_A_F_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 15U))
...
#define CASTOR_KEY_A_G_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 10U))
#define CASTOR_KEY_A_G_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 4U))
#define CASTOR_KEY_A_G_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 2U))
#define CASTOR_KEY_A_G_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 12U))
...
#define CASTOR_KEY_A_G_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 4U))
#define CASTOR_KEY_A_G_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 5U))
#define CASTOR_KEY_A_G_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 15U))
#define CASTOR_KEY_A_G_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 6U))
...
#define CASTOR_KEY_A_G_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 9U))
#define CASTOR_KEY_A_G_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 8U))
#define CASTOR_KEY_A_G_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_G_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 6U))
...
#define CASTOR_KEY_A_G_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 11U))
#define CASTOR_KEY_A_G_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_G_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 14U))
#define CASTOR_KEY_A_G_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 7U))
#define CASTOR_KEY_A_G_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_G_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 14U))
#define CASTOR_KEY_A_G_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 9U))
#define CASTOR_KEY_A_G_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 3U))
#define CASTOR_KEY_A_G_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 11U))
#define CASTOR_KEY_A_G_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 10U))
#define CASTOR_KEY_A_G_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 15U))
#define CASTOR_KEY_A_G_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 1U))
...
#define CASTOR_KEY_A_G_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 14U))
#define CASTOR_KEY_A_G_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 2U))
#define CASTOR_KEY_A_G_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 15U))
#define CASTOR_KEY_A_G_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 5U))
...
#define CASTOR_KEY_A_G_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 13U))
#define CASTOR_KEY_A_G_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 7U))
#define CASTOR_KEY_A_G_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 12U))
#define CASTOR_KEY_A_G_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 1U))
#define CASTOR_KEY_A_G_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 15U))
#define CASTOR_KEY_A_G_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 2U))
#define CASTOR_KEY_A_G_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 0U))
#define CASTOR_KEY_A_G_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 1U))
#define CASTOR_KEY_A_G_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_G_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 6U))
#define CASTOR_KEY_A_G_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 15U))
#define CASTOR_KEY_A_G_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 12U))
#define CASTOR_KEY_A_G_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_G_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 15U))
#define CASTOR_KEY_A_G_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 8U))
#define CASTOR_KEY_A_G_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 10U))
#define CASTOR_KEY_A_G_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 3U))
#define CASTOR_KEY_A_G_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 9U))
#define CASTOR_KEY_A_G_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 8U))
#define CASTOR_KEY_A_G_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 0U))
#define CASTOR_KEY_A_G_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 5U))
#define CASTOR_KEY_A_G_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 14U))
#define CASTOR_KEY_A_G_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 12U))
#define CASTOR_KEY_A_G_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 10U))
#define CASTOR_KEY_A_G_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 9U))
#define CASTOR_KEY_A_G_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 8U))
#define CASTOR_KEY_A_G_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 13U))
#define CASTOR_KEY_A_G_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 11U))
#define CASTOR_KEY_A_G_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 5U))
#define CASTOR_KEY_A_G_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_G_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 7U))
#define CASTOR_KEY_A_G_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 13U))
...
#define CASTOR_KEY_A_H_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 4U))
#define CASTOR_KEY_A_H_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_H_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 5U))
#define CASTOR_KEY_A_H_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 7U))
...
#define CASTOR_KEY_A_H_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 15U))
#define CASTOR_KEY_A_H_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 7U))
#define CASTOR_KEY_A_H_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 0U))
...
#define CASTOR_KEY_A_H_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 6U))
#define CASTOR_KEY_A_H_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 3U))
#define CASTOR_KEY_A_H_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 11U))
...
#define CASTOR_KEY_A_H_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 12U))
#define CASTOR_KEY_A_H_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 10U))
#define CASTOR_KEY_A_H_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 5U))
#define CASTOR_KEY_A_H_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 1U))
#define CASTOR_KEY_A_H_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 13U))
#define CASTOR_KEY_A_H_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 10U))
#define CASTOR_KEY_A_H_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 6U))
#define CASTOR_KEY_A_H_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 12U))
#define CASTOR_KEY_A_H_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 9U))
#define CASTOR_KEY_A_H_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 3U))
#define CASTOR_KEY_A_H_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 0U))
#define CASTOR_KEY_A_H_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 4U))
...
#define CASTOR_KEY_A_H_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 3U))
#define CASTOR_KEY_A_H_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 4U))
#define CASTOR_KEY_A_H_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 8U))
#define CASTOR_KEY_A_H_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 11U))
...
#define CASTOR_KEY_A_H_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 6U))
#define CASTOR_KEY_A_H_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 5U))
#define CASTOR_KEY_A_H_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 3U))
#define CASTOR_KEY_A_H_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 7U))
#define CASTOR_KEY_A_H_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 5U))
#define CASTOR_KEY_A_H_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 1U))
#define CASTOR_KEY_A_H_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 12U))
#define CASTOR_KEY_A_H_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 4U))
#define CASTOR_KEY_A_H_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 13U))
#define CASTOR_KEY_A_H_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 1U))
#define CASTOR_KEY_A_H_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 12U))
#define CASTOR_KEY_A_H_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 10U))
#define CASTOR_KEY_A_H_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 12U))
#define CASTOR_KEY_A_H_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 1U))
#define CASTOR_KEY_A_H_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 5U))
#define CASTOR_KEY_A_H_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 9U))
#define CASTOR_KEY_A_H_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 2U))
#define CASTOR_KEY_A_H_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 12U))
#define CASTOR_KEY_A_H_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 7U))
#define CASTOR_KEY_A_H_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 5U))
#define CASTOR_KEY_A_H_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 6U))
#define CASTOR_KEY_A_H_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 8U))
#define CASTOR_KEY_A_H_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 1U))
#define CASTOR_KEY_A_H_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 11U))
#define CASTOR_KEY_A_H_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 6U))
#define CASTOR_KEY_A_H_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 7U))
#define CASTOR_KEY_A_H_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 4U))
#define CASTOR_KEY_A_H_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 15U))
#define CASTOR_KEY_A_H_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 7U))
#define CASTOR_KEY_A_H_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 2U))
#define CASTOR_KEY_A_H_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 14U))
#define CASTOR_KEY_A_H_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 1U))
...
#define CASTOR_KEY_B_A_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 6U))
#define CASTOR_KEY_B_A_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 10U))
#define CASTOR_KEY_B_A_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_A_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 15U))
...
#define CASTOR_KEY_B_A_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 5U))
#define CASTOR_KEY_B_A_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_A_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 4U))
#define CASTOR_KEY_B_A_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 3U))
...
#define CASTOR_KEY_B_A_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_A_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 15U))
#define CASTOR_KEY_B_A_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 5U))
#define CASTOR_KEY_B_A_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 14U))
...
#define CASTOR_KEY_B_A_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 8U))
#define CASTOR_KEY_B_A_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 12U))
#define CASTOR_KEY_B_A_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 15U))
#define CASTOR_KEY_B_A_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 14U))
#define CASTOR_KEY_B_A_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_A_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 4U))
#define CASTOR_KEY_B_A_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 5U))
#define CASTOR_KEY_B_A_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 13U))
#define CASTOR_KEY_B_A_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_A_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 8U))
#define CASTOR_KEY_B_A_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 4U))
#define CASTOR_KEY_B_A_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 3U))
...
#define CASTOR_KEY_B_A_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 5U))
#define CASTOR_KEY_B_A_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 7U))
...
#define CASTOR_KEY_B_A_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_A_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 2U))
#define CASTOR_KEY_B_A_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_A_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 4U))
#define CASTOR_KEY_B_A_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 13U))
#define CASTOR_KEY_B_A_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 0U))
#define CASTOR_KEY_B_A_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 15U))
#define CASTOR_KEY_B_A_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 12U))
#define CASTOR_KEY_B_A_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 8U))
#define CASTOR_KEY_B_A_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 10U))
#define CASTOR_KEY_B_A_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 3U))
#define CASTOR_KEY_B_A_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 6U))
#define CASTOR_KEY_B_A_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 10U))
#define CASTOR_KEY_B_A_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 7U))
#define CASTOR_KEY_B_A_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 12U))
#define CASTOR_KEY_B_A_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 3U))
#define CASTOR_KEY_B_A_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 5U))
#define CASTOR_KEY_B_A_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 13U))
#define CASTOR_KEY_B_A_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_A_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 7U))
#define CASTOR_KEY_B_A_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 7U))
#define CASTOR_KEY_B_A_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 12U))
#define CASTOR_KEY_B_A_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 15U))
#define CASTOR_KEY_B_A_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 6U))
#define CASTOR_KEY_B_A_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 4U))
#define CASTOR_KEY_B_A_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 9U))
#define CASTOR_KEY_B_A_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 8U))
#define CASTOR_KEY_B_A_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 0U))
#define CASTOR_KEY_B_A_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 12U))
#define CASTOR_KEY_B_A_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 4U))
#define CASTOR_KEY_B_A_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 5U))
#define CASTOR_KEY_B_A_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 9U))
...
#define CASTOR_KEY_B_B_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 14U))
#define CASTOR_KEY_B_B_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 2U))
#define CASTOR_KEY_B_B_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 8U))
#define CASTOR_KEY_B_B_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 6U))
...
#define CASTOR_KEY_B_B_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 15U))
#define CASTOR_KEY_B_B_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 4U))
#define CASTOR_KEY_B_B_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_B_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 8U))
...
#define CASTOR_KEY_B_B_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 13U))
#define CASTOR_KEY_B_B_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 9U))
#define CASTOR_KEY_B_B_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 15U))
#define CASTOR_KEY_B_B_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 10U))
...
#define CASTOR_KEY_B_B_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 14U))
#define CASTOR_KEY_B_B_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 1U))
#define CASTOR_KEY_B_B_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 0U))
#define CASTOR_KEY_B_B_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 8U))
#define CASTOR_KEY_B_B_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 4U))
#define CASTOR_KEY_B_B_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 12U))
#define CASTOR_KEY_B_B_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 2U))
#define CASTOR_KEY_B_B_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 10U))
#define CASTOR_KEY_B_B_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 4U))
#define CASTOR_KEY_B_B_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 7U))
#define CASTOR_KEY_B_B_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 3U))
#define CASTOR_KEY_B_B_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 8U))
...
#define CASTOR_KEY_B_B_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 9U))
#define CASTOR_KEY_B_B_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 6U))
#define CASTOR_KEY_B_B_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 0U))
#define CASTOR_KEY_B_B_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 4U))
...
#define CASTOR_KEY_B_B_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 1U))
#define CASTOR_KEY_B_B_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 3U))
#define CASTOR_KEY_B_B_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_B_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 12U))
#define CASTOR_KEY_B_B_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 7U))
#define CASTOR_KEY_B_B_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 6U))
#define CASTOR_KEY_B_B_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 8U))
#define CASTOR_KEY_B_B_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 15U))
#define CASTOR_KEY_B_B_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 2U))
#define CASTOR_KEY_B_B_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 3U))
#define CASTOR_KEY_B_B_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 0U))
#define CASTOR_KEY_B_B_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 15U))
#define CASTOR_KEY_B_B_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 6U))
#define CASTOR_KEY_B_B_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 9U))
#define CASTOR_KEY_B_B_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 0U))
#define CASTOR_KEY_B_B_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 5U))
#define CASTOR_KEY_B_B_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 13U))
#define CASTOR_KEY_B_B_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 7U))
#define CASTOR_KEY_B_B_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 15U))
#define CASTOR_KEY_B_B_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 1U))
#define CASTOR_KEY_B_B_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_B_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 2U))
#define CASTOR_KEY_B_B_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 11U))
#define CASTOR_KEY_B_B_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 5U))
#define CASTOR_KEY_B_B_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 5U))
#define CASTOR_KEY_B_B_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 10U))
#define CASTOR_KEY_B_B_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 15U))
#define CASTOR_KEY_B_B_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 12U))
#define CASTOR_KEY_B_B_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 13U))
#define CASTOR_KEY_B_B_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 15U))
#define CASTOR_KEY_B_B_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 1U))
...
#define CASTOR_KEY_B_C_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 1U))
#define CASTOR_KEY_B_C_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 9U))
#define CASTOR_KEY_B_C_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 12U))
#define CASTOR_KEY_B_C_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 2U))
...
#define CASTOR_KEY_B_C_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 8U))
#define CASTOR_KEY_B_C_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 6U))
#define CASTOR_KEY_B_C_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 0U))
...
#define CASTOR_KEY_B_C_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_C_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 12U))
...
#define CASTOR_KEY_B_C_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 9U))
#define CASTOR_KEY_B_C_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 14U))
#define CASTOR_KEY_B_C_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_C_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 4U))
#define CASTOR_KEY_B_C_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 1U))
#define CASTOR_KEY_B_C_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 9U))
#define CASTOR_KEY_B_C_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 7U))
#define CASTOR_KEY_B_C_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 0U))
#define CASTOR_KEY_B_C_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 12U))
#define CASTOR_KEY_B_C_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 0U))
#define CASTOR_KEY_B_C_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 5U))
#define CASTOR_KEY_B_C_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 9U))
...
#define CASTOR_KEY_B_C_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 12U))
#define CASTOR_KEY_B_C_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_C_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 6U))
#define CASTOR_KEY_B_C_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 10U))
...
#define CASTOR_KEY_B_C_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 11U))
#define CASTOR_KEY_B_C_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 10U))
#define CASTOR_KEY_B_C_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 7U))
#define CASTOR_KEY_B_C_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 6U))
#define CASTOR_KEY_B_C_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 9U))
#define CASTOR_KEY_B_C_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 3U))
#define CASTOR_KEY_B_C_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_C_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 8U))
#define CASTOR_KEY_B_C_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 3U))
#define CASTOR_KEY_B_C_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_C_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 7U))
#define CASTOR_KEY_B_C_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 13U))
#define CASTOR_KEY_B_C_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 14U))
#define CASTOR_KEY_B_C_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_C_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_C_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 15U))
#define CASTOR_KEY_B_C_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_C_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 14U))
#define CASTOR_KEY_B_C_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 12U))
#define CASTOR_KEY_B_C_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 8U))
#define CASTOR_KEY_B_C_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 3U))
#define CASTOR_KEY_B_C_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 7U))
#define CASTOR_KEY_B_C_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_C_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 13U))
#define CASTOR_KEY_B_C_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 11U))
#define CASTOR_KEY_B_C_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 1U))
#define CASTOR_KEY_B_C_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_C_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 8U))
#define CASTOR_KEY_B_C_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 2U))
#define CASTOR_KEY_B_C_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 5U))
#define CASTOR_KEY_B_C_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 8U))
#define CASTOR_KEY_B_C_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 0U))
...
#define CASTOR_KEY_B_D_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 3U))
#define CASTOR_KEY_B_D_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 14U))
#define CASTOR_KEY_B_D_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 13U))
#define CASTOR_KEY_B_D_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 11U))
...
#define CASTOR_KEY_B_D_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 7U))
#define CASTOR_KEY_B_D_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 14U))
#define CASTOR_KEY_B_D_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 12U))
#define CASTOR_KEY_B_D_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 2U))
...
#define CASTOR_KEY_B_D_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 5U))
#define CASTOR_KEY_B_D_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 0U))
#define CASTOR_KEY_B_D_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 1U))
#define CASTOR_KEY_B_D_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 8U))
...
#define CASTOR_KEY_B_D_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 10U))
#define CASTOR_KEY_B_D_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 0U))
#define CASTOR_KEY_B_D_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 11U))
#define CASTOR_KEY_B_D_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 2U))
#define CASTOR_KEY_B_D_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 10U))
#define CASTOR_KEY_B_D_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_D_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 3U))
#define CASTOR_KEY_B_D_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 1U))
#define CASTOR_KEY_B_D_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 6U))
#define CASTOR_KEY_B_D_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 1U))
#define CASTOR_KEY_B_D_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 11U))
#define CASTOR_KEY_B_D_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 15U))
...
#define CASTOR_KEY_B_D_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 13U))
#define CASTOR_KEY_B_D_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 8U))
#define CASTOR_KEY_B_D_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 1U))
#define CASTOR_KEY_B_D_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 6U))
...
#define CASTOR_KEY_B_D_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 12U))
#define CASTOR_KEY_B_D_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_D_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 13U))
#define CASTOR_KEY_B_D_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 14U))
#define CASTOR_KEY_B_D_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_D_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 4U))
#define CASTOR_KEY_B_D_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 2U))
#define CASTOR_KEY_B_D_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 11U))
#define CASTOR_KEY_B_D_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 14U))
#define CASTOR_KEY_B_D_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 9U))
#define CASTOR_KEY_B_D_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_D_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 0U))
#define CASTOR_KEY_B_D_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 15U))
#define CASTOR_KEY_B_D_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 8U))
#define CASTOR_KEY_B_D_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 3U))
#define CASTOR_KEY_B_D_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 7U))
#define CASTOR_KEY_B_D_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 1U))
#define CASTOR_KEY_B_D_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 10U))
#define CASTOR_KEY_B_D_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 11U))
#define CASTOR_KEY_B_D_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 15U))
#define CASTOR_KEY_B_D_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 8U))
#define CASTOR_KEY_B_D_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 9U))
#define CASTOR_KEY_B_D_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 5U))
#define CASTOR_KEY_B_D_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 3U))
#define CASTOR_KEY_B_D_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 15U))
#define CASTOR_KEY_B_D_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 2U))
#define CASTOR_KEY_B_D_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 0U))
#define CASTOR_KEY_B_D_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 7U))
#define CASTOR_KEY_B_D_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_D_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 13U))
#define CASTOR_KEY_B_D_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 6U))
...
#define CASTOR_KEY_B_E_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 5U))
#define CASTOR_KEY_B_E_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 13U))
#define CASTOR_KEY_B_E_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 9U))
#define CASTOR_KEY_B_E_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 4U))
...
#define CASTOR_KEY_B_E_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 3U))
#define CASTOR_KEY_B_E_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 13U))
#define CASTOR_KEY_B_E_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 6U))
#define CASTOR_KEY_B_E_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 11U))
...
#define CASTOR_KEY_B_E_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 11U))
#define CASTOR_KEY_B_E_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 2U))
#define CASTOR_KEY_B_E_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 12U))
#define CASTOR_KEY_B_E_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 15U))
...
#define CASTOR_KEY_B_E_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 4U))
#define CASTOR_KEY_B_E_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 8U))
#define CASTOR_KEY_B_E_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 2U))
#define CASTOR_KEY_B_E_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 9U))
#define CASTOR_KEY_B_E_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 12U))
#define CASTOR_KEY_B_E_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 1U))
#define CASTOR_KEY_B_E_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_E_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 11U))
#define CASTOR_KEY_B_E_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 10U))
...
#define CASTOR_KEY_B_E_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 5U))
#define CASTOR_KEY_B_E_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 0U))
#define CASTOR_KEY_B_E_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_E_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 8U))
...
#define CASTOR_KEY_B_E_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 14U))
#define CASTOR_KEY_B_E_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 8U))
#define CASTOR_KEY_B_E_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 15U))
#define CASTOR_KEY_B_E_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 10U))
#define CASTOR_KEY_B_E_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 8U))
#define CASTOR_KEY_B_E_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 7U))
#define CASTOR_KEY_B_E_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 13U))
#define CASTOR_KEY_B_E_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_E_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 7U))
#define CASTOR_KEY_B_E_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 5U))
#define CASTOR_KEY_B_E_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 4U))
#define CASTOR_KEY_B_E_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 9U))
#define CASTOR_KEY_B_E_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 0U))
#define CASTOR_KEY_B_E_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 4U))
#define CASTOR_KEY_B_E_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 13U))
#define CASTOR_KEY_B_E_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 4U))
#define CASTOR_KEY_B_E_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_E_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 9U))
#define CASTOR_KEY_B_E_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 6U))
#define CASTOR_KEY_B_E_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 2U))
#define CASTOR_KEY_B_E_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 1U))
#define CASTOR_KEY_B_E_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 3U))
#define CASTOR_KEY_B_E_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 14U))
#define CASTOR_KEY_B_E_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 14U))
#define CASTOR_KEY_B_E_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 5U))
#define CASTOR_KEY_B_E_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_E_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 3U))
#define CASTOR_KEY_B_E_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 8U))
#define CASTOR_KEY_B_E_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 7U))
#define CASTOR_KEY_B_E_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 11U))
#define CASTOR_KEY_B_E_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 6U))
...
#define CASTOR_KEY_B_F_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 9U))
#define CASTOR_KEY_B_F_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 0U))
#define CASTOR_KEY_B_F_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 7U))
#define CASTOR_KEY_B_F_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 5U))
...
#define CASTOR_KEY_B_F_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 8U))
#define CASTOR_KEY_B_F_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 2U))
#define CASTOR_KEY_B_F_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 15U))
...
#define CASTOR_KEY_B_F_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 13U))
#define CASTOR_KEY_B_F_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 0U))
#define CASTOR_KEY_B_F_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 3U))
...
#define CASTOR_KEY_B_F_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 5U))
#define CASTOR_KEY_B_F_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_F_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 9U))
#define CASTOR_KEY_B_F_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 6U))
#define CASTOR_KEY_B_F_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 15U))
#define CASTOR_KEY_B_F_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 6U))
#define CASTOR_KEY_B_F_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 11U))
#define CASTOR_KEY_B_F_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 2U))
#define CASTOR_KEY_B_F_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 1U))
#define CASTOR_KEY_B_F_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 12U))
#define CASTOR_KEY_B_F_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_F_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 2U))
...
#define CASTOR_KEY_B_F_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 6U))
#define CASTOR_KEY_B_F_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 3U))
#define CASTOR_KEY_B_F_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 13U))
#define CASTOR_KEY_B_F_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 12U))
...
#define CASTOR_KEY_B_F_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 14U))
#define CASTOR_KEY_B_F_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 6U))
#define CASTOR_KEY_B_F_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 1U))
#define CASTOR_KEY_B_F_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 13U))
#define CASTOR_KEY_B_F_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 11U))
#define CASTOR_KEY_B_F_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 7U))
#define CASTOR_KEY_B_F_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_F_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 3U))
#define CASTOR_KEY_B_F_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 5U))
#define CASTOR_KEY_B_F_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 15U))
#define CASTOR_KEY_B_F_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 1U))
#define CASTOR_KEY_B_F_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 9U))
#define CASTOR_KEY_B_F_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 5U))
#define CASTOR_KEY_B_F_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 13U))
#define CASTOR_KEY_B_F_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_F_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 4U))
#define CASTOR_KEY_B_F_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 14U))
#define CASTOR_KEY_B_F_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 8U))
#define CASTOR_KEY_B_F_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 5U))
#define CASTOR_KEY_B_F_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 2U))
#define CASTOR_KEY_B_F_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 4U))
#define CASTOR_KEY_B_F_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 10U))
#define CASTOR_KEY_B_F_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 6U))
#define CASTOR_KEY_B_F_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 0U))
#define CASTOR_KEY_B_F_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_F_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_F_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 1U))
#define CASTOR_KEY_B_F_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 9U))
#define CASTOR_KEY_B_F_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 11U))
#define CASTOR_KEY_B_F_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 14U))
#define CASTOR_KEY_B_F_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 9U))
#define CASTOR_KEY_B_F_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 12U))
...
#define CASTOR_KEY_B_G_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_G_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 15U))
#define CASTOR_KEY_B_G_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 11U))
#define CASTOR_KEY_B_G_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 13U))
...
#define CASTOR_KEY_B_G_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 11U))
#define CASTOR_KEY_B_G_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 1U))
#define CASTOR_KEY_B_G_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 5U))
...
#define CASTOR_KEY_B_G_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 6U))
#define CASTOR_KEY_B_G_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 4U))
#define CASTOR_KEY_B_G_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_G_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 2U))
...
#define CASTOR_KEY_B_G_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 15U))
#define CASTOR_KEY_B_G_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 5U))
#define CASTOR_KEY_B_G_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 13U))
#define CASTOR_KEY_B_G_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 0U))
#define CASTOR_KEY_B_G_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 3U))
#define CASTOR_KEY_B_G_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 8U))
#define CASTOR_KEY_B_G_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 4U))
#define CASTOR_KEY_B_G_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 7U))
#define CASTOR_KEY_B_G_LunarLaneA (pWorkSpace->mLunarLaneA + (W_KEY * 3U))
#define CASTOR_KEY_B_G_LunarLaneB (pWorkSpace->mLunarLaneB + (W_KEY * 14U))
#define CASTOR_KEY_B_G_LunarLaneC (pWorkSpace->mLunarLaneC + (W_KEY * 8U))
#define CASTOR_KEY_B_G_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 7U))
...
#define CASTOR_KEY_B_G_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 2U))
#define CASTOR_KEY_B_G_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 1U))
#define CASTOR_KEY_B_G_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 10U))
#define CASTOR_KEY_B_G_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 0U))
...
#define CASTOR_KEY_B_G_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 9U))
#define CASTOR_KEY_B_G_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 12U))
#define CASTOR_KEY_B_G_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 15U))
#define CASTOR_KEY_B_G_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 2U))
#define CASTOR_KEY_B_G_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 14U))
#define CASTOR_KEY_B_G_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 13U))
#define CASTOR_KEY_B_G_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 3U))
#define CASTOR_KEY_B_G_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 6U))
#define CASTOR_KEY_B_G_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 15U))
#define CASTOR_KEY_B_G_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 13U))
#define CASTOR_KEY_B_G_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 4U))
#define CASTOR_KEY_B_G_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 8U))
#define CASTOR_KEY_B_G_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 1U))
#define CASTOR_KEY_B_G_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 5U))
#define CASTOR_KEY_B_G_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 13U))
#define CASTOR_KEY_B_G_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 0U))
#define CASTOR_KEY_B_G_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 10U))
#define CASTOR_KEY_B_G_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 15U))
#define CASTOR_KEY_B_G_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 6U))
#define CASTOR_KEY_B_G_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 4U))
#define CASTOR_KEY_B_G_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 9U))
#define CASTOR_KEY_B_G_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_G_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_G_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 7U))
#define CASTOR_KEY_B_G_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 7U))
#define CASTOR_KEY_B_G_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 4U))
#define CASTOR_KEY_B_G_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 9U))
#define CASTOR_KEY_B_G_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 2U))
#define CASTOR_KEY_B_G_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 1U))
#define CASTOR_KEY_B_G_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 0U))
#define CASTOR_KEY_B_G_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 4U))
#define CASTOR_KEY_B_G_AlchemyLaneD (pWorkSpace->mAlchemyLaneD + (W_KEY * 14U))
...
#define CASTOR_KEY_B_H_HeartLaneA (pWorkSpace->mHeartLaneA + (W_KEY * 7U))
#define CASTOR_KEY_B_H_HeartLaneB (pWorkSpace->mHeartLaneB + (W_KEY * 11U))
#define CASTOR_KEY_B_H_HeartLaneC (pWorkSpace->mHeartLaneC + (W_KEY * 4U))
#define CASTOR_KEY_B_H_HeartLaneD (pWorkSpace->mHeartLaneD + (W_KEY * 9U))
...
#define CASTOR_KEY_B_H_CelestialLaneA (pWorkSpace->mCelestialLaneA + (W_KEY * 6U))
#define CASTOR_KEY_B_H_CelestialLaneB (pWorkSpace->mCelestialLaneB + (W_KEY * 3U))
#define CASTOR_KEY_B_H_CelestialLaneC (pWorkSpace->mCelestialLaneC + (W_KEY * 8U))
#define CASTOR_KEY_B_H_CelestialLaneD (pWorkSpace->mCelestialLaneD + (W_KEY * 5U))
...
#define CASTOR_KEY_B_H_KineticLaneA (pWorkSpace->mKineticLaneA + (W_KEY * 8U))
#define CASTOR_KEY_B_H_KineticLaneB (pWorkSpace->mKineticLaneB + (W_KEY * 14U))
#define CASTOR_KEY_B_H_KineticLaneC (pWorkSpace->mKineticLaneC + (W_KEY * 9U))
#define CASTOR_KEY_B_H_KineticLaneD (pWorkSpace->mKineticLaneD + (W_KEY * 4U))
...
#define CASTOR_KEY_B_H_FrostLaneA (pWorkSpace->mFrostLaneA + (W_KEY * 0U))
#define CASTOR_KEY_B_H_FrostLaneB (pWorkSpace->mFrostLaneB + (W_KEY * 6U))
#define CASTOR_KEY_B_H_FrostLaneC (pWorkSpace->mFrostLaneC + (W_KEY * 3U))
#define CASTOR_KEY_B_H_FrostLaneD (pWorkSpace->mFrostLaneD + (W_KEY * 15U))
#define CASTOR_KEY_B_H_ArcaneLaneA (pWorkSpace->mArcaneLaneA + (W_KEY * 11U))
#define CASTOR_KEY_B_H_ArcaneLaneB (pWorkSpace->mArcaneLaneB + (W_KEY * 0U))
#define CASTOR_KEY_B_H_ArcaneLaneC (pWorkSpace->mArcaneLaneC + (W_KEY * 8U))
#define CASTOR_KEY_B_H_ArcaneLaneD (pWorkSpace->mArcaneLaneD + (W_KEY * 9U))
...
#define CASTOR_KEY_B_H_LunarLaneD (pWorkSpace->mLunarLaneD + (W_KEY * 11U))
...
#define CASTOR_KEY_B_H_AbjurationLaneA (pWorkSpace->mAbjurationLaneA + (W_KEY * 10U))
#define CASTOR_KEY_B_H_AbjurationLaneB (pWorkSpace->mAbjurationLaneB + (W_KEY * 7U))
#define CASTOR_KEY_B_H_AbjurationLaneC (pWorkSpace->mAbjurationLaneC + (W_KEY * 12U))
#define CASTOR_KEY_B_H_AbjurationLaneD (pWorkSpace->mAbjurationLaneD + (W_KEY * 2U))
...
#define CASTOR_KEY_B_H_AuguryLaneA (pWorkSpace->mAuguryLaneA + (W_KEY * 10U))
#define CASTOR_KEY_B_H_AuguryLaneB (pWorkSpace->mAuguryLaneB + (W_KEY * 8U))
#define CASTOR_KEY_B_H_AuguryLaneC (pWorkSpace->mAuguryLaneC + (W_KEY * 0U))
#define CASTOR_KEY_B_H_AuguryLaneD (pWorkSpace->mAuguryLaneD + (W_KEY * 5U))
#define CASTOR_KEY_B_H_ProphecyLaneA (pWorkSpace->mProphecyLaneA + (W_KEY * 8U))
#define CASTOR_KEY_B_H_ProphecyLaneB (pWorkSpace->mProphecyLaneB + (W_KEY * 5U))
#define CASTOR_KEY_B_H_ProphecyLaneC (pWorkSpace->mProphecyLaneC + (W_KEY * 6U))
#define CASTOR_KEY_B_H_ProphecyLaneD (pWorkSpace->mProphecyLaneD + (W_KEY * 0U))
#define CASTOR_KEY_B_H_TransmutationLaneA (pWorkSpace->mTransmutationLaneA + (W_KEY * 1U))
#define CASTOR_KEY_B_H_TransmutationLaneB (pWorkSpace->mTransmutationLaneB + (W_KEY * 4U))
#define CASTOR_KEY_B_H_TransmutationLaneC (pWorkSpace->mTransmutationLaneC + (W_KEY * 14U))
#define CASTOR_KEY_B_H_TransmutationLaneD (pWorkSpace->mTransmutationLaneD + (W_KEY * 2U))
#define CASTOR_KEY_B_H_RestorationLaneA (pWorkSpace->mRestorationLaneA + (W_KEY * 3U))
#define CASTOR_KEY_B_H_RestorationLaneB (pWorkSpace->mRestorationLaneB + (W_KEY * 6U))
#define CASTOR_KEY_B_H_RestorationLaneC (pWorkSpace->mRestorationLaneC + (W_KEY * 9U))
#define CASTOR_KEY_B_H_RestorationLaneD (pWorkSpace->mRestorationLaneD + (W_KEY * 1U))
#define CASTOR_KEY_B_H_StasisLaneA (pWorkSpace->mStasisLaneA + (W_KEY * 11U))
#define CASTOR_KEY_B_H_StasisLaneB (pWorkSpace->mStasisLaneB + (W_KEY * 6U))
#define CASTOR_KEY_B_H_StasisLaneC (pWorkSpace->mStasisLaneC + (W_KEY * 0U))
#define CASTOR_KEY_B_H_StasisLaneD (pWorkSpace->mStasisLaneD + (W_KEY * 3U))
#define CASTOR_KEY_B_H_MysticalLaneA (pWorkSpace->mMysticalLaneA + (W_KEY * 1U))
#define CASTOR_KEY_B_H_MysticalLaneB (pWorkSpace->mMysticalLaneB + (W_KEY * 5U))
#define CASTOR_KEY_B_H_MysticalLaneC (pWorkSpace->mMysticalLaneC + (W_KEY * 7U))
#define CASTOR_KEY_B_H_MysticalLaneD (pWorkSpace->mMysticalLaneD + (W_KEY * 4U))
#define CASTOR_KEY_B_H_CovenLaneA (pWorkSpace->mCovenLaneA + (W_KEY * 12U))
#define CASTOR_KEY_B_H_CovenLaneB (pWorkSpace->mCovenLaneB + (W_KEY * 6U))
#define CASTOR_KEY_B_H_CovenLaneC (pWorkSpace->mCovenLaneC + (W_KEY * 7U))
#define CASTOR_KEY_B_H_CovenLaneD (pWorkSpace->mCovenLaneD + (W_KEY * 10U))
#define CASTOR_KEY_B_H_AlchemyLaneA (pWorkSpace->mAlchemyLaneA + (W_KEY * 15U))
#define CASTOR_KEY_B_H_AlchemyLaneB (pWorkSpace->mAlchemyLaneB + (W_KEY * 9U))
#define CASTOR_KEY_B_H_AlchemyLaneC (pWorkSpace->mAlchemyLaneC + (W_KEY * 0U))
